							...
							<div <?php post_class('media-item animate-onscroll '); ?>>
								...
								<div class="media-image">
									...
									<?php if(get_option('sense_show_share_madia') == 'show')
										...
										<?php if(get_option('sense_show_share_madia') == 'show')
											...
											<span><?php esc_html_e( 'Share This', THEMENAME ); ?>:</span>
								...
								<div class="media-info">
									...
									<div class="media-button">
										<a href="<?php echo $media['post-link']; ?>" class="button big button-arrow"><?php esc_html_e( 'More info', THEMENAME ); ?></a>
										<?php 
										if(isset($media['project-link']) && $media['project-link'] != '') echo '<a href="'. esc_url($media['project-link']) .'" target="_blank" class="button big button-arrow">' . __( 'View Project' , THEMENAME) . '</a>';
										?>
									</div>
