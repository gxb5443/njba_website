...
<section id="content">	
			...
			<section class="section page-heading ">
				<h1><?php printf( __( 'Author Archives: %s', THEMENAME ), " " . esc_attr(get_the_author()) . "" ); ?></h1>
			...
			<div class="row">
				...
				<?php 
					if ( get_the_author_meta( 'description' ) ) : ?>
						...
						<h2><?php printf( __( 'About %s', THEMENAME ), esc_attr(get_the_author()) ); ?></h2>
					...
					<div <?php post_class('blog-post animate-onscroll '); ?> >
						...
						<div class="post-content">
							...
							<div class="post-exceprt">
								...
								<a href="<?php echo get_permalink(); ?>" class="button read-more-button big button-arrow"><?php esc_html_e( 'Read More', THEMENAME ); ?></a>
