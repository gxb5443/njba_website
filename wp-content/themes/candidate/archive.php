...
<section id="content">	
			...
			<?php _e( 'Archive ', THEMENAME ); ?><?php single_cat_title(); ?> 
			<?php  } elseif( is_tag() ) { ?>
			<?php _e( 'Posts Tagged &#8216;', THEMENAME ); ?><?php single_tag_title(); ?>&#8217;
			<?php  } elseif (is_day()) { ?>
			<?php _e( 'Archive for', THEMENAME ); ?> <?php the_time('F jS, Y'); ?>
			<?php  } elseif (is_month()) { ?>
			<?php _e( 'Archive for', THEMENAME ); ?> <?php the_time('F, Y'); ?>
			<?php  } elseif (is_year()) { ?>
			<?php _e( 'Archive for', THEMENAME ); ?><?php the_time('Y'); ?>
			<?php  } elseif (is_author()) { ?>
			<?php _e( 'Author Archive', THEMENAME ); ?>
