			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'comment_notes_after'  => '',
						'fields'               => array(
							'author' => '<div class="inline-inputs"><div class="col-lg-6 col-md-6 col-sm-6">' . '<label for="author">' . __( 'Name', 'woocommerce' ) . '*</label> ' .
							            '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" /></div>',
							'email'  => '<div class="col-lg-6 col-md-6 col-sm-6"><label for="email">' . __( 'Email', 'woocommerce' ) . '*</label> ' .
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<label for="rating">' . __( 'Your rating*', 'woocommerce' ) .'</label>
