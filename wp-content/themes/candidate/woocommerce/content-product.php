...
<div <?php post_class( 'col-lg-4 col-md-4 col-sm-6 mix ' ); ?> data-dateorder="<?php  echo $post->post_date; ?>" data-popularorder="<?php  echo $num_comments1; ?>" data-avgratingorder="<?php  echo $num_rating1; ?>" data-priceorder="<?php  echo $price1; ?>">
