...
class Candidat_WP_Widget_Calendar extends WP_Widget {
	...
	function Candidat_WP_Widget_Calendar() {
		$widget_ops = array( 'classname' => 'widget_calendar_custom', 'description' => __('A calendar of your site&#8217;s Posts.', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_calendar_custom' ); //default width = 250
		$this->WP_Widget( 'widget_calendar_custom', THEMENAME.' - '.__('Custom Calendar', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		<p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', THEMENAME); ?></label>
 ...
 */
 class Candidat_WP_Nav_Menu_Widget1 extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'description' => __('Add a custom menu to your footer sidebar.', THEMENAME) );
		parent::__construct( 'nav_menu_custom', THEMENAME.' - '.__('Custom Menu Bottom', THEMENAME), $widget_ops );
	}
	function widget($args, $instance) {
		// Get menu
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>"><?php _e('Select Menu1:', THEMENAME); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('nav_menu2')); ?>"><?php _e('Select Menu2:', THEMENAME); ?></label>
...
class Candidat_Banner_Icon_Widget extends WP_Widget {
	...
	function Candidat_Banner_Icon_Widget() {
		$widget_ops = array( 'classname' => 'widget_banner_icon', 'description' => __('Banner with Icon', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_banner_icon' ); //default width = 250
		$this->WP_Widget( 'widget_banner_icon', THEMENAME.' - '.__('Banner Icon', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('icon')); ?>"><?php _e( 'Select Icon:', THEMENAME ); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link')); ?>"><?php _e('URL Banner:', THEMENAME); ?></label>
		...
		<p>
		<label><?php _e( 'Target:', THEMENAME ); ?></label>
		<select name="<?php echo esc_attr($this->get_field_name('custom_links_target')); ?>" id="<?php echo esc_attr($this->get_field_id('custom_links_target')); ?>" class="widefat">
			<option value="_self"<?php selected( $instance['custom_links_target'], '_self' ); ?>><?php _e( 'Same window', THEMENAME ); ?></option>
			<option value="_blank"<?php selected( $instance['custom_links_target'], '_blank' ); ?>><?php _e( 'New window', THEMENAME ); ?></option>
		</select>
		</p>
		...
		<p><label><strong><?php _e( 'Color Button:', THEMENAME ); ?></strong></label></p>
...
class Candidat_Banner_Donate_Widget extends WP_Widget {
	...
	function Candidat_Banner_Donate_Widget() {
		$widget_ops = array( 'classname' => 'widget_banner_donate', 'description' => __('Banner Donate.', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_banner_donate' ); //default width = 250
		$this->WP_Widget( 'widget_banner_donate', THEMENAME.' - '.__('Banner Donate', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('text_amount1')); ?>"><?php _e('Amount1:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('text_amount2')); ?>"><?php _e('Amount2:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('text_amount3')); ?>"><?php _e('Amount3:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('url_amount')); ?>"><?php _e('PayPal Email Address:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('org_donate')); ?>"><?php _e('Organization:', THEMENAME); ?></label>
		...
		<p>
		<label><?php _e( 'Currency Amount1:', THEMENAME ); ?></label>
...
class Candidat_WP_Widget_Social extends WP_Widget {
	...
	function Candidat_WP_Widget_Social() {
		$widget_ops = array( 'classname' => 'widget_social', 'description' => __('A social button for your site.', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_social' ); //default width = 250
		$this->WP_Widget( 'widget_social', THEMENAME.' - '.__('Social widget', THEMENAME), $widget_ops, $control_ops );
	}
	...
	?>
		<p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>
		<br>


		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link1')); ?>"><?php _e('Facebook URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link1')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link1')); ?>" type="text" value="<?php echo esc_attr($custom_link1); ?>" /></label></p>


		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link2')); ?>"><?php _e('Twitter URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link2')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link2')); ?>" type="text" value="<?php echo esc_attr($custom_link2); ?>" /></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link3')); ?>"><?php _e('Google Plus URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link3')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link3')); ?>" type="text" value="<?php echo esc_attr($custom_link3); ?>" /></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link4')); ?>"><?php _e('Youtube URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link4')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link4')); ?>" type="text" value="<?php echo esc_attr($custom_link4); ?>" /></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link5')); ?>"><?php _e('Flickr URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link5')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link5')); ?>" type="text" value="<?php echo esc_attr($custom_link5); ?>" /></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link6')); ?>"><?php _e('Email URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link6')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link6')); ?>" type="text" value="<?php echo esc_attr($custom_link6); ?>" /></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link7')); ?>"><?php _e('LinkedIn URL Link:', THEMENAME); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link7')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link7')); ?>" type="text" value="<?php echo esc_attr($custom_link7); ?>" /></label></p>
		...
		<p>
		<label><?php _e( 'Social Show:', THEMENAME ); ?></label>
		<select name="<?php echo esc_attr($this->get_field_name('social_show')); ?>" id="<?php echo esc_attr($this->get_field_id('social_show')); ?>" class="widefat">
			<option value="_show"<?php selected( $instance['social_show'], '_show' ); ?>><?php _e( 'Show', THEMENAME ); ?></option>
			<option value="_hide"<?php selected( $instance['social_show'], '_hide' ); ?>><?php _e( 'Hide', THEMENAME ); ?></option>
		</select>
		</p>
	<?php
	}
...
class Candidat_Featured_Video_Widget extends WP_Widget {
	...
	function Candidat_Featured_Video_Widget() {
		$widget_ops = array( 'classname' => 'widget_featured_video', 'description' => __('Featured Video.', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_featured_video' ); //default width = 250
		$this->WP_Widget( 'widget_featured_video', THEMENAME.' - '.__('Featured Video', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('video_link')); ?>"><?php _e('Video URL:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link')); ?>"><?php _e('Button URL:', THEMENAME); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link')); ?>" type="text" value="<?php echo esc_attr($custom_link); ?>" /></p>
	
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link_text')); ?>"><?php _e('Button Text:', THEMENAME); ?></label>
		...
		<p>
		<label><?php _e( 'Type Video:', THEMENAME ); ?></label>
		<select name="<?php echo esc_attr($this->get_field_name('type_video')); ?>" id="<?php echo esc_attr($this->get_field_id('type_video')); ?>" class="widefat">
			<option value="youtube"<?php selected( $instance['type_video'], 'youtube' ); ?>><?php _e( 'youtube', THEMENAME ); ?></option>
			<option value="vimeo"<?php selected( $instance['type_video'], 'vimeo' ); ?>><?php _e( 'vimeo', THEMENAME ); ?></option>
			<option value="html5"<?php selected( $instance['type_video'], 'html5' ); ?>><?php _e( 'html5', THEMENAME ); ?></option>
		</select>
		</p>	
	<?php
	}
...
class Candidat_Banner_Img_Widget extends WP_Widget {
	...
	function Candidat_Banner_Img_Widget() {
		$widget_ops = array( 'classname' => 'widget_banner_img', 'description' => __('Banner with Image', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_banner_img' ); //default width = 250
		$this->WP_Widget( 'widget_banner_img', THEMENAME.' - '.__('Banner', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_image')); ?>"><?php _e('Path Image:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('custom_link_text')); ?>"><?php _e('Banner Text:', THEMENAME); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_link_text')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_link_text')); ?>" type="text" value="<?php echo esc_attr($custom_link_text); ?>" /></p>
...
class Candidat_My_Flickr_Widget extends WP_Widget {
	...
	function Candidat_My_Flickr_Widget() {
		$widget_ops = array( 'classname' => 'widget_flickr_img', 'description' => __('Flickr Image', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_flickr_img' ); //default width = 250
		$this->WP_Widget( 'widget_flickr_img', THEMENAME.' - '.__('Flickr images', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('flickr_id')); ?>"><?php _e('Flickr ID:', THEMENAME); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php _e('Count:', THEMENAME); ?></label>
		...
		<select name="<?php echo esc_attr($this->get_field_name('type')); ?>" id="<?php echo esc_attr($this->get_field_id('type')); ?>" class="widefat">
			<option value="user"<?php selected( $instance['type'], 'user' ); ?>><?php _e( 'User', THEMENAME ); ?></option>
			<option value="group"<?php selected( $instance['type'], 'group' ); ?>><?php _e( 'Group', THEMENAME ); ?></option>
		</select>
		</p>
		
		<p>
		<label><?php _e( 'Display:', THEMENAME ); ?></label>
		<select name="<?php echo esc_attr($this->get_field_name('display')); ?>" id="<?php echo esc_attr($this->get_field_id('display')); ?>" class="widefat">
			<option value="latest"<?php selected( $instance['display'], 'latest' ); ?>><?php _e( 'Latest', THEMENAME ); ?></option>
			<option value="random"<?php selected( $instance['display'], 'random' ); ?>><?php _e( 'Random', THEMENAME ); ?></option>
		</select>
		</p>
...
class Candidat_WP_Widget_Recent_Posts1 extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_latest_posts', 'description' => __( "Your site&#8217;s most Popular Posts.", THEMENAME) );
		parent::__construct('latest-posts', THEMENAME.' - '.__('Popular Posts', THEMENAME), $widget_ops);
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'num_items' )); ?>"><?php _e( 'Number of posts to show:', THEMENAME ); ?></label>
...
class Candidat_Instagram_Widget extends WP_Widget {
	...
	function Candidat_Instagram_Widget() {
		$widget_ops = array( 'classname' => 'widget_instagram', 'description' => __('INSTAGRAM', THEMENAME) );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'widget_instagram' ); //default width = 250
		$this->WP_Widget( 'widget_instagram', THEMENAME.' - '.__('INSTAGRAM PHOTOS', THEMENAME), $widget_ops, $control_ops );
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('inst_id'); ?>"><?php _e('ID Instagram(0ce2a8c0d92248cab8d2a9d024f7f3ca):', THEMENAME); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Number Instagram:', THEMENAME); ?></label>
...
class Candidat_Mailchimp_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'zn_mailchimp',  THEMENAME.' - '.__('Newsletter', THEMENAME), $widget_ops );
	...
	function widget($args, $instance) {
		...
		<form id="newsletter" action="#" method="POST">
						...
						if ( !empty($instance['title']) ) {
							...
							<h5><strong><?php _e( 'Sign up', THEMENAME ); ?></strong> <?php _e( 'for email updates', THEMENAME ); ?></h5>
							<?php }
						?>	
