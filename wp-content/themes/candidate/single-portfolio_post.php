		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<div class="portfolio-single">
					...
					<div class="row">			
								<div class="col-lg-4 col-md-4 col-sm-6 animate-onscroll">
									...
									<h6><?php esc_html_e( 'Project Details', THEMENAME ); ?></h6>
									
									<table class="project-details">
										
										<tr>
											<td><?php esc_html_e( 'Date', THEMENAME ); ?>:</td>
											<td><?php  the_time('M d Y'); ?></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Category', THEMENAME ); ?>:</td>
											<td><?php echo  $cat;  ?></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Author', THEMENAME ); ?>:</td>
											<td><?php the_author_posts_link(); ?></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Skills', THEMENAME ); ?>:</td>
											<td><?php echo  $cat_skills;  ?></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Comments', THEMENAME ); ?>:</td>
											<td><a href="#comment-form"><?php echo $num_comments; ?></a></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Tags', THEMENAME ); ?>:</td>
											<td><?php echo  $cat_tags;  ?></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Project URL', THEMENAME ); ?>:</td>
											<td><a href="<?php echo  $project_link ; ?> " class="button transparent button-arrow"><?php esc_html_e( 'View Project', THEMENAME ); ?></a></td>
										</tr>
										
										<tr>
											<td><?php esc_html_e( 'Share this', THEMENAME ); ?>:</td>
											<td>
								...
								<div class="col-lg-8 col-md-8 col-sm-6 animate-onscroll">
									...
									<h6><?php esc_html_e( 'Description', THEMENAME ); ?></h6>
			...
			<div class="row portfolio-pagination">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 align-center animate-onscroll">
					<a href="<?php echo get_option('sense_projects_url'); ?>" class="button big"><?php esc_html_e( 'All projects', THEMENAME ); ?></a>
				</div>
			...
			<h3 class="animate-onscroll row-separator-caption"><?php esc_html_e( 'Related Projects', THEMENAME ); ?></h3>
			...
			<div class="post-comments">
				<h3 class="animate-onscroll"><?php _e( 'Comments', THEMENAME ); ?></h3>
				<ul>
			...
			<h3 class="animate-onscroll"><?php _e( 'Leave a reply', THEMENAME ); ?></h3>
			<p class="animate-onscroll"><?php _e( 'Your email address will not be published. Fields marked * are mandatory.', THEMENAME ); ?></p>
			
			<?php
				$comment_field = '<div class="col-lg-12 col-md-12 col-sm-12"><label>'. __( 'Comment*', THEMENAME ) .'</label>
								<textarea  rows="10" name="comment" ></textarea>
								</div>';
				$fields =  array(
				'author' => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'Name*', THEMENAME ) .'</label>
							<input type="text" name="author" value="" >
							</div>',  
				'email'  => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'E-mail*', THEMENAME ) .'</label>
							<input type="email" name="email" value="" >
							</div>',  
				'url'    => '<div class="col-lg-4 col-md-4 col-sm-4"><label>'. __( 'Website', THEMENAME ) .'</label>
				...
				$comments_args = array(
						...
						'label_submit' => '',
						'title_reply' => '',  
						'title_reply_to' => __( '<h4 style="margin-top:0; margin-bottom:10px;" >Leave a Reply to %s</h4>', THEMENAME ),   
