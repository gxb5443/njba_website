						...
						<div class="col-lg-8 col-md-8 col-sm-8 animate-onscroll">
							<div class="social-media">
								<ul class="social-icons">
									...
									<li class="facebook"><a href="<?php echo esc_url(get_option('sense_footer_url1')); ?>" class="tooltip-ontop" title="Facebook"><i class="icons icon-facebook"></i></a></li>
									<?php } ?>	
								
									<?php if(get_option('sense_footer_url2') != '' && get_option('sense_footer_url2') != '#' ) { ?>
									<li class="twitter"><a href="<?php echo esc_url(get_option('sense_footer_url2')); ?>" class="tooltip-ontop" title="Twitter"><i class="icons icon-twitter"></i></a></li>
									<?php } ?>
									
									<?php if(get_option('sense_footer_url3') != '' && get_option('sense_footer_url3') != '#' ) { ?>
									<li class="google"><a href="<?php echo esc_url(get_option('sense_footer_url3')); ?>" class="tooltip-ontop" title="Google Plus"><i class="icons icon-gplus"></i></a></li>
									<?php } ?>
									
									<?php if(get_option('sense_footer_url4') != '' && get_option('sense_footer_url4') != '#' ) { ?>
									<li class="youtube"><a href="<?php echo esc_url(get_option('sense_footer_url4')); ?>" class="tooltip-ontop" title="Youtube"><i class="icons icon-youtube-1"></i></a></li>
									<?php } ?>
									
									<?php if(get_option('sense_footer_url5') != '' && get_option('sense_footer_url5') != '#' ) { ?>
									<li class="flickr"><a href="<?php echo esc_url(get_option('sense_footer_url5')); ?>" class="tooltip-ontop" title="Flickr"><i class="icons icon-flickr-4"></i></a></li>
									<?php } ?>
									
									<?php if(get_option('sense_footer_url6') != '' && get_option('sense_footer_url6') != '#' ) { ?>
									<li class="email"><a href="<?php echo esc_url(get_option('sense_footer_url6')); ?>" class="tooltip-ontop" title="Email"><i class="icons icon-mail"></i></a></li>
									<?php } ?>
									
									<?php if(get_option('sense_footer_url7') != '' && get_option('sense_footer_url7') != '#' ) { ?>
									<li class="linkedin"><a href="<?php echo esc_url(get_option('sense_footer_url7')); ?>" class="tooltip-ontop" title="LinkedIn"><i class="icons icon-linkedin"></i></a></li>
									<?php } ?>
