			...
			<div class="row">
				...
				<div class="media-filters animate-onscroll">
					...
					<div class="filter-filtering">
						...
						<label><?php echo __('Show',THEMENAME);?>:</label>
						<ul class="filter-dropdown">
							<li><span><?php echo __('All',THEMENAME);?></span>
							<?php 
							if($portfolio_category): ?>
								<ul>
									<li class="filter" data-filter="all"><?php echo __('All',THEMENAME);?></li>
					...
					<label><?php esc_html_e( 'Sort by', THEMENAME ); ?>:</label>
					<div class="filter-sorting">
						
						<div class="order-group active-sort ascending-sort">
							<button class="small sort sorting-asc" data-sort="nameorder:asc"><?php esc_html_e( 'Name', THEMENAME ); ?></button>
							<button class="small sort sorting-desc" data-sort="nameorder:desc"><?php esc_html_e( 'Name', THEMENAME ); ?></button>
						</div>
						
						<div class="order-group">
							<button class="small sort sorting-asc" data-sort="dateorder:asc"><?php esc_html_e( 'Date', THEMENAME ); ?></button>
							<button class="small sort sorting-desc" data-sort="dateorder:desc"><?php esc_html_e( 'Date', THEMENAME ); ?></button>
						</div>
