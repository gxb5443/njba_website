...
class Latest_Tweets_Widget extends WP_Widget {
    ...
    public function __construct( $id_base = false, $name = 'Candidate Latest Tweets', $widget_options = array(), $control_options = array() ){
        ...
        $this->options = array(
            array (
                'name'  => 'title',
                'label' => __('Widget title', THEMENAME),
                'type'  => 'text'
            ),
            array (
                'name'  => 'screen_name',
                'label' => __('Twitter handle', THEMENAME),
                'type'  => 'text'
            ),
            array (
                'name'  => 'num',
                'label' => __('Number of tweets', THEMENAME),
                'type'  => 'text'
            ),
    ...
    private function check_instance( $instance ){
        ...
        $instance += array (
            'title' => __('Latest Tweets', THEMENAME),
            'screen_name' => '',
            'num' => '5',
            'rts' => '',
            'ats' => '',
    ...
    public function widget( $args, $instance ) {
        ...
        $args['before_widget'], 
            ...
            '<div id="twitter-widget" class=" twitter-widget">', 
                ...
                apply_filters( 'latest_tweets_render_after', '' ),
            '</div>',
			'<a href="http://twitter.com/'. $screen_name .'" class="button twitter-button">Follow us on twitter</a>',
         $args['after_widget'],
		 '</div>';
    }
