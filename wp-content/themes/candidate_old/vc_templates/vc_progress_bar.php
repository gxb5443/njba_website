...
$output = '<div class="vc_progress_bar ' . $css_class . '">';
...
foreach ( $graph_lines_data as $line ) {
	$unit = ( $units != '' ) ? ' <span class="">' . $line['value'] . $units . '</span>' : '';
	...
	$output .= '<p>' . $line['label'] .'</p>
						<div class="progressbar vc_single_bar ' . $bgcolor . '" data-percent="' . $line['value'] . '">
