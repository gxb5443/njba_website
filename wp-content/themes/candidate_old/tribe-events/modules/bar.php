...
<?php do_action('tribe_events_bar_before_template') ?>
	...
	<form id="tribe-bar-form" class="tribe-clearfix white-box animate-onscroll" name="tribe-bar-form" method="post" action="<?php echo esc_attr( $current_url ); ?>">
		...
		<h5><?php _e( 'Find Events', 'tribe-events-calendar' ); ?></h5>
		...
		?>
				...
				<div class="col-lg-2 col-md-2 col-sm-3">
					<button type="submit" name="submit-bar"  class="medium"><i class="icons icon-search"></i> <?php _e( 'Find Events', 'tribe-events-calendar' ); ?></button>
