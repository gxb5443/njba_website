...
class DHVCFormAdmin {
	...
	public function init(){
		...
		$this->setting_fields = array(
				...
				'recaptcha_public_key'=>array(
						'type'=>'text',
						'label'=>__('Public key',DHVC_FORM),
				),
				'recaptcha_private_key'=>array(
						'type'=>'text',
						'label'=>__('Private key',DHVC_FORM),
				),
				'mailchimp'=>array(
						'type'=>'heading',
		...
		$this->meta_boxs = array(
				...
				array (
					...
					"name" => "mailpoet",
					"options" => $this->_get_mailpoet_Subscribers_list(),
				),
				array (
						"type" => "text",
	...
	protected function _get_mailpoet_Subscribers_list(){
