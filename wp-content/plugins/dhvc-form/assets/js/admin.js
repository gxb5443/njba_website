...
(function ($) {
	...
	var setting_notice = function(checkbox){
		var notice_arr  = ['notice_name_field','notice_email_type_field','notice_variables_field','notice_email_field','notice_recipients_field','notice_subject_field','notice_body_field','notice_html_field'];
