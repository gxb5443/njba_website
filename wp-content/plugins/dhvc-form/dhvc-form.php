...
if(!defined('DHVC_FORM_VERSION'))
	define('DHVC_FORM_VERSION','1.3.4');
...
//define('DHVC_FORM_SUPORT_WYSIJA', false);
...
class DHVCForm {
	...
	public function frontend_assets(){
		...
		wp_register_script('dhvc-form',DHVC_FORM_URL.'/assets/js/script.js',array('jquery','jquery-ui-slider','dhvc-form-validate'),DHVC_FORM_VERSION);
	...
	public function dhvc_form_popup(){
		...
		if($form->have_posts()):
			...
			if(get_post_meta(get_the_ID(),'_form_popup',true)){
				...
				$auto_open = get_post_meta(get_the_ID(),'_form_popup_trigger',true);
